...
import math
from slang_gaussian_tomography.internal.sort_by_keys import sort_by_keys_cub
...
class VertexShader(torch.autograd.Function):
    @staticmethod
    def forward(ctx, xyz_ws, rotations, scales, scale3d_factor, world_view_transform,
                proj_mat, cam_pos, fovy, fovx, render_grid):
      n_points = xyz_ws.shape[0]
      ...
      ctx.save_for_backward(xyz_ws, rotations, scales, scale3d_factor, world_view_transform, proj_mat, cam_pos,
    ...
    def backward(ctx, grad_tiles_touched, grad_rect_tile_space, grad_radii, grad_xyz_vs, grad_xyz3d_cam, grad_inv_cov_vs, grad_inv_cov3d_vs, grad_rgb):
        (xyz_ws, rotations, scales, scale3d_factor, world_view_transform, proj_mat, cam_pos,
        ...
        return grad_xyz_ws, grad_rotations, grad_scales, grad_scale3d_factor, None, None, None, None, None, None